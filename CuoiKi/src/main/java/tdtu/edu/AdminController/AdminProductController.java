package tdtu.edu.AdminController;
...
public class AdminProductController {
    ...
    public String Save( Model model,@Validated @ModelAttribute("item") Product item, BindingResult errors  , @RequestParam("photo") MultipartFile multipartFile, @RequestParam("p") Optional<Integer> p) throws IOException {
         ...
         if(errors.hasErrors()){
             ...
             Category category = check.findById(item.getCategory().getId());
